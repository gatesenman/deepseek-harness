...
const NO_MODEL_EXPERIENCE_SECTION: Readonly<Record<string, string>> = {
  ...
  'packages/experimental/ontology-model': 'The package is a model-agnostic in-memory ontology modeling library; it registers no prompt, tool schema, or model-visible output.',
  'packages/experimental/ontology-studio': 'The package is a standalone browser editor over the ontology model library; it registers no prompt, tool schema, or model-visible output.',
